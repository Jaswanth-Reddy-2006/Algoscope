...
const VITE_API_BASE_URL = (import.meta as any).env.VITE_API_BASE_URL || 'http://localhost:5000';
const API_BASE_URL = VITE_API_BASE_URL.endsWith('/api') ? VITE_API_BASE_URL : `${VITE_API_BASE_URL}/api`;
